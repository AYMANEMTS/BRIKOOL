            ...
            <div className='flex flex-wrap items-center max-lg:gap-y-6 max-sm:gap-x-4'>
                ...
                <div className='flex items-center ml-auto space-x-8'>
                    ...
                    <div className="flex space-x-4">
                        <a href="#" title="Notifications" className="hover:text-blue-500">
                            <svg className="w-6 h-6" fill="#000" viewBox="0 0 24 24">
                                <path
                                    d="M12 24c-1.104 0-2-.896-2-2h4c0 1.104-.896 2-2 2zm6.364-4h-12.728c-1.105 0-2-.895-2-2v-5c0-6.627 5.373-12 12-12s12 5.373 12 12v5c0 1.105-.895 2-2 2z"/>
                            </svg>
                        </a>
                        <a href="#" title="Profile" className="hover:text-blue-500">
                            <svg className="w-6 h-6" fill="#000" viewBox="0 0 24 24">
                                <path
                                    d="M12 12c2.209 0 4-1.791 4-4s-1.791-4-4-4-4 1.791-4 4 1.791 4 4 4zm0 2c-4.418 0-8 3.582-8 8v2h16v-2c0-4.418-3.582-8-8-8z"/>
                            </svg>
                        </a>
                    </div>
                </div>
