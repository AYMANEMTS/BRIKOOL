            ...
            <div className=" py-8">
                <div className="flex flex-wrap -mx-4">
                    ...
                    <div className="w-full md:w-1/2 px-4">
                        ...
                        <p className="text-gray-700 mb-6">Experience premium sound quality and industry-leading
                            noise cancellation
                            with
                        ...
                        <div className="flex space-x-4 mb-6">
                            ...
                            <button
                                className="bg-gray-200 flex gap-2 items-center  text-gray-800 px-3 py-3 rounded-full hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                     strokeWidth="1.5" stroke="currentColor" className="size-6">
                                    <path strokeLinecap="round" strokeLinejoin="round"
